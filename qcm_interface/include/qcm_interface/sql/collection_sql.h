...
public:
    ...
    virtual auto select_id(model::ItemId user_id, QString type = {})
        -> asio::awaitable<std::vector<model::ItemId>>                             = 0;
    virtual auto refresh(model::ItemId user_id, i64 provider_id, QString type, std::span<const model::ItemId>,
