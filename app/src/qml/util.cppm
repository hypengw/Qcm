...
#ifdef Q_MOC_RUN
#    include "Qcm/qml/util.moc"
#endif

export module qcm:qml.util;
...
public:
    ...
    Q_INVOKABLE static msg::filter::TypeFilter          typeFilter() noexcept;
    ...
    Q_INVOKABLE static rstd::cppstd::vector<model::ItemId> collect_ids(QAbstractItemModel* model);
