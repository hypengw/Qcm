...
#ifdef Q_MOC_RUN
#include "Qcm/query/storage_info.moc"
#endif

export module qcm:query.storage_info;
...
export class StorageInfo : public QObject {
    Q_OBJECT
...
export class StorageInfoQuery : public Query, public QueryExtra<StorageInfo, StorageInfoQuery> {
    Q_OBJECT
    QML_ELEMENT
public:
