...
#ifdef Q_MOC_RUN
#    include "Qcm/query/mix_query.moc"
#endif

export module qcm:query.mix;
...
export class RemoteMixesQuery : public QueryList,
...
export class MixesQuery : public QueryList, public QueryExtra<model::MixListModel, MixesQuery> {
    Q_OBJECT
    QML_ELEMENT
...
export class MixQuery : public Query, public QueryExtra<model::MixStoreItem, MixQuery> {
    Q_OBJECT
    QML_ELEMENT
...
export class MixSongsQuery : public QueryList,
                             public QueryExtra<model::MixSongListModel, MixSongsQuery> {
    Q_OBJECT
    QML_ELEMENT
...
export class CreateMixQuery : public Query, public QueryExtra<msg::CreateMixRsp, CreateMixQuery> {
    Q_OBJECT
    QML_ELEMENT
...
export class DeleteMixQuery : public Query, public QueryExtra<msg::Rsp, DeleteMixQuery> {
    Q_OBJECT
    QML_ELEMENT
...
public:
    ...
    auto ids() const -> rstd::cppstd::vector<model::ItemId>;
    void setIds(const rstd::cppstd::vector<model::ItemId>&);

    Q_SIGNAL void idsChanged();

private:
    rstd::cppstd::vector<model::ItemId> m_ids;
};
...
public:
    ...
    auto songIds() const -> rstd::cppstd::vector<model::ItemId>;
    void setSongIds(const rstd::cppstd::vector<model::ItemId>&);
    auto albumIds() const -> rstd::cppstd::vector<model::ItemId>;
    void setAlbumIds(const rstd::cppstd::vector<model::ItemId>&);
...
private:
    ...
    rstd::cppstd::vector<model::ItemId>                    m_song_ids;
    rstd::cppstd::vector<model::ItemId>                    m_album_ids;
};
