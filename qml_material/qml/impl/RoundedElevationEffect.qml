...
MD.ElevationEffect {
    property int roundedScale: MT.Material.FullScale

    _shadows: roundedScale === MT.Material.NotRounded ? _defaultShadows : roundedShadows()
    ...
    function roundedShadows() {
        ...
        for (let i = 0, strength = 0.95; i < shadows.length; ++i) {
            ...
            // as I can get it.
            strength = Math.max(0.05, strength - (roundedScale > MT.Material.ExtraSmallScale ? 0.1 : 0.3))
