 ...
 * 1) Set a break point in CppRequestGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class CppRequestGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("cpp-request") // use this codegen library
              ...
              .setOutputDir("out/cpp-request"); // output directory
