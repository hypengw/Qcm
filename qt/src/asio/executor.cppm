...
public:
    ...
    QtExecutor(const QtExecutor& o) noexcept: m_ctx(o.m_ctx) { debug_assert(m_ctx); }
    // same as copy as no need to drop
    QtExecutor(QtExecutor&& o) noexcept: m_ctx(o.m_ctx) { debug_assert(m_ctx); }
